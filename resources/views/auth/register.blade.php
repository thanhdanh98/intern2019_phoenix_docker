    ...
    >
        ...
        <div class="field mb-6">
            ...
            <div class="control">
                <input id="name"
                       type="text"
                       class="input bg-transparent border-2 border-grey rounded p-2 text-xs w-full{{ $errors->has('name') ? ' is-invalid' : '' }}"
                       name="name"
                       value="{{ old('name') }}"
                       required
                       autofocus>
        ...
        <div class="field mb-6">
            ...
            <div class="control">
                <input id="email"
                       type="email"
                       class="input bg-transparent border-2 border-grey rounded p-2 text-xs w-full{{ $errors->has('email') ? ' is-invalid' : '' }}"
                       name="email"
                       value="{{ old('email') }}"
                       required>
            </div>
        ...
        <div class="field mb-6">
            ...
            <div class="control">
                <input id="password"
                       type="password"
                       class="input bg-transparent border-2 border-grey rounded p-2 text-xs w-full{{ $errors->has('password') ? ' is-invalid' : '' }}"
                       name="password"
                       required>
            </div>
        </div>
        ...
        <div class="field mb-6">
            ...
            <div class="control">
                <input id="password-confirmation"
                       type="password"
                       class="input bg-transparent border-2 border-grey rounded p-2 text-xs w-full"
